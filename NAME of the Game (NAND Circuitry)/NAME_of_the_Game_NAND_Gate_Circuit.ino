...
const char button_2_q2[] PROGMEM = "Slow down!";
const char button_3_q2[] PROGMEM = "Ready...set...GO";
...
const int ANDinBlue = A3;
const int ANDinYellow = A2;
const int ANDinGreen = 2;
const int ANDinRed = 3;
...
void setup() {
    ...
    pinMode(ANDinBlue, OUTPUT);
    pinMode(ANDinYellow, OUTPUT);
    pinMode(ANDinGreen, OUTPUT);
    pinMode(ANDinRed, OUTPUT);
    ...
    while(gameStart == true) {
       ...
       while(game == true){
          ...
          while(digitalRead(yellow) == HIGH or digitalRead(blue) == HIGH or digitalRead(red) == HIGH or digitalRead(green) == HIGH /*and readButt == true*/) {
              ...
              digitalWrite(ANDinBlue, correctBlue);
              digitalWrite(ANDinYellow, correctYellow);
              digitalWrite(ANDinGreen, correctGreen);
              digitalWrite(ANDinRed, correctRed);
